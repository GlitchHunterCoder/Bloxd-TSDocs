...
export type MeshEntityOpts = {
	...
	Leaderboard: LeaderboardMeshOpts
...
export type LeaderboardMeshOpts = CommonMeshEntityOpts & {
	leaderboard: string
	title?: string
	scoreLabel?: string
}
...
export interface _TypeOf {
	...
	customItemStats: readonly ["ttb", "displayName", "harvestLevel", "stoodOnSpeedMultiplier", "specialToolDrop", "specialToolBonusDrops", "description", "altActionable", "eatHealAmt", "eatShieldAmt", "damage", "attackRange", "attackCooldownMs", "secondaryDamage", "absorbThrowable", "armourReduction", "CrosshairText", "gunStats", "showInCreativeInven", "bridgeLength"]
